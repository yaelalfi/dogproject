...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{scaleX:0.2066,scaleY:0.2066,x:254,y:206}},{t:this.text,p:{font:"20px 'Rubik Medium'",color:"#000000"}}]}).to({state:[{t:this.instance,p:{scaleX:0.2658,scaleY:0.2659,x:240,y:186}},{t:this.text,p:{font:"bold 20px 'Rubik'",color:"#1D4987"}}]},1).to({state:[{t:this.text,p:{font:"20px 'Rubik Medium'",color:"#999999"}},{t:this.instance_1}]},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{scaleX:0.1945,scaleY:0.1944,x:51,y:62}},{t:this.text,p:{x:75.5,font:"20px 'Rubik Medium'",color:"#000000",lineWidth:69}}]}).to({state:[{t:this.instance,p:{scaleX:0.2769,scaleY:0.2768,x:40,y:36}},{t:this.text,p:{x:75.55,font:"bold 20px 'Rubik'",color:"#1D4987",lineWidth:71}}]},1).to({state:[{t:this.text,p:{x:75.5,font:"20px 'Rubik Medium'",color:"#999999",lineWidth:69}},{t:this.instance_1}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(38.1,36,75,143.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{scaleX:0.1805,scaleY:0.1805,x:170,y:259}},{t:this.text,p:{font:"20px 'Rubik Medium'",color:"#000000"}}]}).to({state:[{t:this.instance,p:{scaleX:0.2563,scaleY:0.2563,x:149,y:235}},{t:this.text,p:{font:"bold 20px 'Rubik'",color:"#1D4987"}}]},1).to({state:[{t:this.text,p:{font:"20px 'Rubik Medium'",color:"#999999"}},{t:this.instance_1}]},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{scaleX:0.1782,scaleY:0.1783,x:-7,y:17}},{t:this.text,p:{x:33,font:"20px 'Rubik Medium'",color:"#000000",lineWidth:74}}]}).to({state:[{t:this.instance,p:{scaleX:0.2363,scaleY:0.2364,x:-20,y:-5}},{t:this.text,p:{x:33.05,font:"bold 20px 'Rubik'",color:"#1D4987",lineWidth:94}}]},1).to({state:[{t:this.text,p:{x:33,font:"20px 'Rubik Medium'",color:"#999999",lineWidth:74}},{t:this.instance_1}]},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{scaleX:0.2762,scaleY:0.2762,x:108,y:260}},{t:this.text,p:{font:"20px 'Rubik Medium'",color:"#000000"}}]}).to({state:[{t:this.instance,p:{scaleX:0.3333,scaleY:0.3332,x:98,y:239}},{t:this.text,p:{font:"bold 20px 'Rubik'",color:"#1D4987"}}]},1).to({state:[{t:this.instance_1},{t:this.text,p:{font:"20px 'Rubik Medium'",color:"#999999"}}]},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.exit = new lib.x();
	this.exit.name = "exit";
	this.exit.setTransform(748.9,330.75,0.0732,0.0732);
	new cjs.ButtonHelper(this.exit, 0, 1, 2, false, new lib.x(), 3);

	this.timeline.addTween(cjs.Tween.get(this.exit).wait(12).to({x:917.05,y:311.2},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		function NoP(){
			...
			self.building.cursor = "auto";
			self.garden.cursor = "auto";
			self.single.cursor = "auto";
			self.family.cursor = "auto";
			self.old.cursor = "auto";
			self.rot.cursor = "auto";
			self.pikinez.cursor = "auto";
			self.roee.cursor = "auto";
			self.york.cursor = "auto";
			self.pumernian.cursor = "auto";
			self.husky.cursor = "auto";
			self.jack.cursor = "auto";
			self.golden.cursor = "auto";
			self.lavrador.cursor = "auto";
			self.pug.cursor = "auto";
			self.shizu.cursor = "auto";
			self.pitbull.cursor = "auto";
			self.about.cursor = "auto";
		}
	}
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/Dogs_YYS_atlas_1.png?1633459042837", id:"Dogs_YYS_atlas_1"}
	],
	preloads: []
};
